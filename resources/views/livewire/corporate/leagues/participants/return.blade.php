@php
    ...
    $participantsUrl = RouteFacade::has('corporate.leagues.participants')
        ? route('corporate.leagues.participants', $league)   // if you have this named route
        : url('/corporate/leagues/'.$league->id.'/participants'); // fallback by path
@endphp

<x-layouts.app title="Upgrade to Pro">
<div class="mx-auto max-w-3xl px-4 py-10">
    <div class="mb-6">
        <a href="{{ route('corporate.leagues.show', $league) }}" class="inline-flex items-center text-sm text-gray-500 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
        ...
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                <h1 class="text-xl font-semibold text-gray-900 dark:text-white">
                    CSV Import Payment — {{ $league->title }}
                </h1>
                ...
                <div class="mt-6 flex flex-wrap gap-3">
                    {{-- Participants page: if you have a named route for it, swap in here. Otherwise link to league show. --}}
                    <flux:button as="a" href="{{ $participantsUrl }}" variant="primary">
                        Go to Participants
                    </flux:button>

                    {{-- Optional: link to confirm page if you store/know the import id here. This page doesn’t get it, so we omit. --}}
                ...
                <div class="mt-4">
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        This page is safe to close. You can continue managing your league while we finish up.
                    </p>
                </div>
            </div>
        </div>
